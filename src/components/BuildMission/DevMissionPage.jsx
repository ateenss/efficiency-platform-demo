...
import {closeDetailMission,closeGoTestDetail,closeDevMissionDetail} from "../../actions/BuildMissionAction"
...
class MissionDetailMain extends React.Component {
    ...
    handleClose = () => {
        store.dispatch(closeDevMissionDetail());
    };
    ...
    render() {
        const {classes,tempBoardToDetail,detailDevMissionShow} = this.props;

        return (

            <div>
                <Dialog  fullScreen open={detailDevMissionShow} onClose={this.handleClose} TransitionComponent={Transition}>
...
const mapStateToProps = (state) => {
    return {
        ...
        detailDevMissionShow:state.reducer.buildMission.detailDevMissionShow,
